...
def main():
    ...
    greedy_output = "\n".join(
        [
            "Жадібний алгоритм:",
            f"Обрані позиції: {greedy_result['selected_items']}",
            f"Загальна вартість: {greedy_result['total_cost']}",
            f"Загальна калорійність: {greedy_result['total_calories']}",
        ]
    )
    ...
    dynamic_output = "\n".join(
        [
            ...
            f"Обрані позиції: {dynamic_result['selected_items']}",
            f"Загальна вартість: {dynamic_result['total_cost']}",
            f"Загальна калорійність: {dynamic_result['total_calories']}",
        ]
    )
